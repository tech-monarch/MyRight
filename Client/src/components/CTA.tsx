      ...
      >
        ...
        <div className="relative z-10">
          <h2
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-3xl md:text-4xl lg:text-[40px] font-extrabold text-white mb-6 tracking-tight"
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="300"
            className="text-blue-100/90 text-sm md:text-base leading-relaxed max-w-2xl mx-auto mb-10"
          >
