    ...
    <section className="px-6 md:px-12 py-12 md:py-16 font-sans overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, delay: 0.2 }}
          className="relative w-full h-[400px] lg:h-[600px] mt-8 lg:mt-0 rounded-2xl border border-white shadow-sm overflow-hidden"
        >
          <img 
            src="/hero.png" 
          ...
          <motion.div
            ...
            className="absolute bottom-6 left-6 right-6 lg:bottom-8 lg:left-8 lg:right-8 bg-white p-5 lg:p-6 rounded-xl shadow-lg border border-(--color-border-light)"
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="bg-(--color-primary-light) p-1.5 rounded-full flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-(--color-primary-blue)">
                  <path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path>
                  <path d="m9 12 2 2 4-4"></path>
                </svg>
              </div>
              <span className="text-sm font-bold text-(--color-primary-navy)">Nigerian Legal Compliance</span>
            </div>
